<div id="content-wrapper">
  <div class="container-fluid mb-5">
    <ol class="breadcrumb">
      <li class="breadcrumb-item active">Órdenes de trabajo / Detalles</li>
    </ol>
    <div class="accordion" id="accordionExample">
      <div class="card mb-3">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
          <div class="card-body">
            En esta sección puede visualizar detalles a profundidas sobre la orden de trabajo seleccionada.
          </div>
        </div>
      </div>
    </div>
      ...
      <div id="collapseTwo" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
        ...
        <div class="row mb-2">
          ...
          <div class="row mb-2">
              ...
              <div class="col-md-4 mb-3" id='frm_state'>
                  <label>Estado</label>
          ...
          <div class="row mb-2">
              ...
              <div class="col-md-4 mb-3" id='frm_state'>
                  ...
                  <input type="text" class="form-control" name="location" id="location" value='<?= $location ?>' disabled>
              </div>
      <!--        <div class="col-md-2 mb-3" style="margin: auto;">
          ...
          <div class="row mb-2">
              ...
              <div class="col-md-2 mb-3" style="margin: auto;">
                  <button  type="button" id="images"class="btn btn-primary btn-success">Ver imágenes</button>
              </div>
        </div>
        </div>
      </div>
  ...
  <div class="form-group">
    <div class="row mb-2">
      <div class="col-md-12 col-lg-2 control-label">
        <button class="btn btn-success float-right form-control" type='button' id="btn_images"><i class="fas fa-plus"></i> Ver Imagenes</button>
      </div>
    <!--  <div class="col-md-12 col-lg-2 control-label">
...
<!-- Modal -->
<div class="modal fade" style="overflow-y: scroll;" id="modal_images" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog mw-100 w-75" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Lista de imágenes</h5>
...
<div class="modal fade" id="show_image" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">              
      <div class="modal-body" >
      	<button type="button" class="close" data-dismiss="modal" onclick="closeModalShow()" ><span aria-hidden="true">&times;</span><span class="sr-only" >Close</span></button>
...
<script src="<?php echo base_url(); ?>assets/js_admin/seller/stagesOrder.js"></script>