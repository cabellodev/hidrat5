...
<div class="table-responsive tab-pane fade show active " id="evaluacion" >
    ...
    <div class="card-header" id="headingEV">
        <h5 class="mb-0">
        <button class="btn btn-link" data-toggle="collapse" data-target="#evaluationnGeneral" aria-expanded="false">
            <i class="fas fa-table"></i>
            Información General
        </button>
        </h5>
      </div>
      <div id="evaluationnGeneral" class="collapse show" aria-labelledby="headingEV">      
            <div class="card-body">  
                      ...
                      <div class="row mb-2 ">
                          <div class="col-md-3 mb-3 ">
                            <div class="form-check">
                              ...
                              <label class="form-check-label"  for="approve_admin_ev">Aprobado por administración</label>
                            </div>
                          </div>
                          <div class="col-md-3 mb-3 ">
                            <div class="form-check">
                                <input class="form-check-input"  style="background:white" type="checkbox" id="approve_technical_ev" disabled>
                                <label class="form-check-label"  for="approve_technical_ev">Aprobado por técnico master</label>
                            </div>
                          </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">
            <button class="btn btn-link" data-toggle="collapse" data-target="#evaluationSubareaPedido" aria-expanded="false">
                <i class="fas fa-table"></i>
                Subtareas
            </button>
            </h5>
        </div>
        <div id="evaluationSubareaPedido" class="collapse">      
            <div class="card-body">
                <div class="card-header">
                    <i class="fas fa-table"></i>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table_evaluation_subtask" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>Id </th>
                                    <th>Fecha</th>
